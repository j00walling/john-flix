...
CREATE TABLE idm.token_status (id INT NOT NULL PRIMARY KEY,
                               value VARCHAR(32) NOT NULL);

CREATE TABLE idm.user_status (id INT NOT NULL PRIMARY KEY,
                              value VARCHAR(32) NOT NULL);

CREATE TABLE idm.role (id INT NOT NULL PRIMARY KEY,
...
CREATE TABLE movies.genre (id INT NOT NULL PRIMARY KEY,
                           name VARCHAR(32) NOT NULL);

CREATE TABLE movies.person (id INT NOT NULL PRIMARY KEY,
...
CREATE TABLE gateway.request(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
